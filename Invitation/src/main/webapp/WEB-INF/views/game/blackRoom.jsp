    ...
    <div id="gameContainer">
        ...
        <div id="gameScreen">
            ...
            <div id="characterDisplay">
                <img class="character-sprite" id="playerSprite" src="/resources/images/character/${character.picture}" alt="${character.name}">
            </div>
        ...
        <div id="dialogueBox">
        	<div id="dialogueBox2">
	            <div class="speaker-name" id="speakerName">${character.name}</div>
                <input type="hidden" class="character-authority" value="${character.authority}">
        ...
        <!-- 플레이어 정보 (상단 좌측) -->
        <div id="playerInfo">
            <div class="character-name">캐릭터 : ${character.name}</div> 
